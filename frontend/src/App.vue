...
<!-- 
  navbar login sayfasında görünmeyecek -->
<!-- 
  <RouterView v-if = "isLoginPage" />

  <div v-else class ="app-loyout" > -->
<!-- 
    sol sidebar -->
    ...
    <!-- <aside class ="siebar" >
      ...
      <div class ="sidebar-footer" >
        ...
        <button
              type = "button"
              class = "logout-buttton"
              @click = "logout"
              >
            
              <i class = "mdi mid-logout"></i>
    ...
    <!-- <div class = "main-area">
      ...
      <header class ="top-header">
        ...
        <div>
          ...
          <h1>
              {{ route.meta.title || "Ameliyathane Planlama Sistemi" }}
          </h1>


          <p>
              Haftalık operasyon planlama ve yönetim sistemi
          </p>
...
<!-- 
  ...
  <nav class = "navbar">
    ...
    <RouterLink to ="/doctor-schedules">Doktor Takvimleri</RouterLink>
...
.sidebar {
  ...
  box-shadow: 8px 0 30px rgb(15 23 42 / 10%);
...
.brand-icon {
  ...
  border-radius: 14px;
  box-shadow: 0 8px 22px rgb(20 184 166 / 25%);
}
...
.sidebar-link.router-link-active {
  ...
  box-shadow: 0 8px 20px rgb(15 118 110 / 17%);
}
